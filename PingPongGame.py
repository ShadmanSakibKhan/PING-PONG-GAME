...
pen.hideturtle()
pen.goto(0, 260)
pen.write("         Player A: 0         Player B: 0         ", align="center", font=('Monaco', 16, "normal"))
def paddle_left_up():
    y = paddle_left.ycor()
    y = y + 15
    paddle_left.sety(y)
...
win.onkeypress(paddle_left_down, "d")
